...
namespace THE.MagicOnion.Shared.Interfaces
{
    public interface IGamingHubReceiver
    {
        ...
        void OnDoAction(Enums.CommandTypeEnum commandType, PlayerEntity[] playerEntities, Guid previousPlayerId, Guid currentPlayerId, Guid targetPlayerId, List<(Guid, int)> pots, List<CardEntity> communityCards, Enums.GameStateEnum gameState, bool isError, string actionMessage, List<(List<Guid>, Enums.HandRankingType)> winnerList);
    }
}