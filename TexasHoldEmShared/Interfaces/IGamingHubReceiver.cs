...
namespace THE.MagicOnion.Shared.Interfaces
{
    public interface IGamingHubReceiver
    {
        ...
        void OnUseJoker(List<PlayerEntity> playerEntities, PlayerEntity jokerUser, List<PlayerEntity> targets, JokerEntity joker, List<PotEntity> pots, bool isError, string actionMessage);
