...
namespace THE.Interfaces
{
    public interface IGamingHubReceiver
    {
        ...
        void OnGameStart(List<PlayerEntity> playerEntities, List<CardEntity> cardPool, PlayerEntity currentPlayer, Enums.GameStateEnum gameState, int roundNumber, bool isFirstRound);
