...
namespace TexasHoldEmUnitTests
{
    public static class SetupClass
    {
        ...
        public static void PurchaseAndUseJoker(TestSystem sut, int jokerToUse, PlayerEntity player, List<PlayerEntity> targets, List<CardEntity> cardsEntities, ref int totalChips)
        {
            ...
            sut.JokerManager.UseJoker(sut.GameLogicManager, player, targets, player.JokerCards.First(), cardsEntities, out var isJokerError, out _, out _);
