...
namespace THE.GameLogic
{
    public interface IJokerManager
    {
        ...
        Enums.UseJokerResponseTypeEnum UseJoker(IGameLogicManager gameLogicManager, PlayerEntity jokerUser, List<PlayerEntity> targets, JokerEntity joker, List<CardEntity> cardEntities, out bool isError, out bool showHand, out string actionMessage);
