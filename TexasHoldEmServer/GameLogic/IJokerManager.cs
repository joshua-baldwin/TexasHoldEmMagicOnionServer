...
namespace TexasHoldEmServer.GameLogic
{
    public interface IJokerManager
    {
        ...
        Enums.UseJokerResponseTypeEnum UseJoker(IGameLogicManager gameLogicManager, PlayerEntity jokerUser, List<PlayerEntity> targets, JokerEntity joker, List<CardEntity> holeCardsToDiscard, out bool isError, out bool showHand, out string actionMessage);
